...
import com.mbs.algaworks.ecommerce.dto.ProdutoDTO;
...
public class BasicoCriteriaTest extends EntityManagerTest {
    ...
    public void projetarResultadoTuple(){
        ...
        criteriaQuery.select(criteriaBuilder.tuple(root.get("id").alias("id"), root.get("nome")));

        TypedQuery<Tuple> typedQuery = entityManager.createQuery(criteriaQuery);
        List<Tuple> lista = typedQuery.getResultList();
        Assert.assertFalse(lista.isEmpty());

        lista.forEach(tupla -> System.out.println("ID: " + tupla.get("id") + " Nome: " + tupla.get(1)));
    }
    ...
    @Test
    public void retornarTodosPedidos(){
        CriteriaBuilder criteriaBuilder = entityManager.getCriteriaBuilder();
        ...
        System.out.println("Quantidade de pedidos: " + lista.size());
    }
